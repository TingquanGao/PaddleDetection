...
class UpdateBBoxFromMask(BaseOperator):
    ...
    When geometric transforms like RandomCrop, RandomExpand, RandomPerspective modify masks,
    ...
    Example with normal masks:
        transforms = [
            {'Decode': {}},
            {'Poly2Mask': {}},
            {'RandomCrop': {}},  # 裁剪改变了mask内容
            {'UpdateBBoxFromMask': {}},  # 从新的mask重新计算bbox
        ]
    ...
    Example with packed masks:
        transforms = [
            ...
            {'RandomCrop': {}},  # 裁剪改变了mask内容
            {'UpdateBBoxFromMask': {}},  # 从新的mask重新计算bbox
            {'UnpackMask': {'compute_bbox': False}},  # bbox已更新，不需重复计算
        ]
    """
